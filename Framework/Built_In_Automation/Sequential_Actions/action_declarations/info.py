...
action_support = (
    ...
    "src element parameter",
    "src parent parameter",
    "src sibling parameter",
    "src child parameter",
    "source element parameter",
    "source parent parameter",
    "source sibling parameter",
    "source child parameter",
    "dst element parameter",
    "dst parent parameter",
    "dst sibling parameter",
    "dst child parameter",
    "destination element parameter",
    "destination parent parameter",
    "destination sibling parameter",
    "destination child parameter",
    "optional parameter",
    "iframe parameter",
    "method",
    "url",
